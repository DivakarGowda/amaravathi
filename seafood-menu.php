                            ...
                            <div class="col-sm-12 col-xs-12">                                                                                   
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/seafood/Butterfly-Prawns-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Butterfly Prawns</h4>
                                                <p class="des">Seafood</p>
                                                <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/seafood/Golden-Fried-Prawns-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Golden Prawns</h4>
                                                <p class="des">Seafood</p>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                               <img src="assets/images/our-menu/seafood/apollo-fish-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Apollo Fish</h4>
                                                <p class="des">Seafood</p>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/seafood/fish-chilli-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Fish Chilli</h4>
                                                <p class="des">Seafood</p>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/seafood/salt-and-pepper-fish-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Fish Salt & Pepper Dry</h4>
                                                <p class="des">Seafood</p>
                                                <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                                <div class="price">Seasonal</div>
                                            </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p class="des">Seafood</p>
                                                <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                                <div class="price">Seasonal</div></div>
                                        </div>
                                        <!-- Box End -->
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/seafood/anjal-fish-fry-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Anjal/Tawa/Rava Fry</h4>
                                                <p class="des">Seafood</p>
                                                <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                                <div class="price">Seasonal</div>
                                            </div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/seafood/pomfret-fish-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Pomfret Fish</h4>
                                                <p class="des">Seafood</p>
