                                        ...
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="nav-item dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Our Menu</a>
                                                <div class="dropdown-menu">
                                                    <div class="dropdown-inner">
                                                        <ul class="list-unstyled">
                                                            <li><a href="andhra-style-menu-near-airport-hyderabad-road-bangalore.php">Andhra Style Menu</a></li>
                                                            <li><a href="chinese-restaurant-in-bangalore.php">Chinese Starter Menu</a></li>
															<li><a href="north-indian-restaurant-near-international-airport-bangalore.php">North-Indian Menu</a></li>
															<li><a href="coastal-style-restaurant-near-airport-devanahalli-bangalore.php">Coastal Style Menu</a></li>
															<li><a href="seafood-restaurant-near-international-airport-in-bangalore.php">Sea Food Menu</a></li>
															<li><a href="arabian-style-restaurant-near-international-airport-devanahalli-in-bangalore.php">Arabian Style Menu</a></li>
															<li><a href="andhra-style-family-restaurant-in-bangalore.php">Tandoori/Egg Menu</a></li>
															<li><a href="andhra-style-restaurant-near-me.php">Chicken/Mutton/Rice Menu</a></li>
															<li><a href="restaurants-near-devanahalli-airport-bangalore.php">Fruit Juice & Milk Shakes Menu</a></li>
															<li><a href="non-veg-restuarant-with-bar-attached-near-airport-bangalore.php">Soups & Salads Menu</a></li>
															<li><a href="new-year-party-restaurants-in-bangalore.php">Icecream & Desserts Menu</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
