                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <ul class="nav nav-tabs list-inline">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#chicken" data-toggle="tab" aria-expanded="false">Chicken</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="tab-pane" id="rice">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/-mutton/palak-kichdi-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Palak Kichadi</h4>
                                                        <p class="des">Rice</p>
