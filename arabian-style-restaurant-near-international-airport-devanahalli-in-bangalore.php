...
<head>
        ...
        <title>Arabian Style Restaurant Near International Airport Devanahalli In Bangalore</title>
        <meta name="keyword" content="Arabian Style Family Restaurant Near International Airport Devanahalli In Bangalore, Arabian Style Restaurant in Bangalore, arabian style restaurant near me."/>
        <meta name="description" content="Best Arabian Style Family Restaurant Near International Airport In Bangalore provides best services in takeaway parcel within 4km radius, prepares all types of arabian dishes."> 
                        ...
                        <div class="col-sm-12">
                            <div class="dish owl-carousel">
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/01.jpg" alt="Arabian-style-family-restaurant-near-airport-in-bangalore" title="Arabian-style-family-restaurant-near-airport-in-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/02.jpg" alt="Arabian-style-family-restaurant-near-airport-in-bangalore" title="Arabian-style-family-restaurant-near-airport-in-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free...</span>
                                            <p>Rs.100</p>
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/03.jpg" alt="Arabian-style-family-restaurant-near-airport-in-bangalore" title="Arabian-style-family-restaurant-near-airport-in-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free...</span>
                                            <p>Rs.100</p>
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/04.jpg" alt="Arabian-style-family-restaurant-near-airport-in-bangalore" title="Arabian-style-family-restaurant-near-airport-in-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free...</span>
                                            <p>Rs.100</p>
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/05.jpg" alt="Arabian-style-family-restaurant-near-airport-in-bangalore" title="Arabian-style-family-restaurant-near-airport-in-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free...</span>
                                            <p>Rs.100</p>
                            ...
                            <div class="col-sm-12 col-xs-12">                                                                                   
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/arabianfood/grilled-chicken-new-amaravathi-gardenia.jpg" alt="Arabian-style-family-restaurant-near-airport-in-bangalore" title="Arabian-style-family-restaurant-near-airport-in-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Grilled Chicken Half</h4>
                                                <p class="des">Arabian Food</p>
                                                <span>Takeaway within 4 kms are Free...</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                               <img src="assets/images/our-menu/arabianfood/shawarma-roll-new-amaravathi-gardenia.jpg" alt="Arabian-style-family-restaurant-near-airport-in-bangalore" title="Arabian-style-family-restaurant-near-airport-in-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Shawarma Roll</h4>
                                                <p class="des">Arabian Food</p>
