...
<head>
        ...
        <title>Chicken/Mutton/Rice Menu</title>
                                    ...
                                    <div class="tab-pane show active" id="chicken">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/chicken-fried-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/chicken-mutton/Chicken-hakka-fried-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/chicken-mutton/singapore-chicken-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/chicken-mutton/sanghai-fried-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/chicken-mutton/schezwan-fried-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                    ...
                                    <div class="tab-pane" id="rice">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/Veg-biryani-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Veg Biryani</h4>
                                                        <p class="des">Rice</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/steamrice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Steam Rice</h4>
                                                        <p class="des">Rice</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/ghee-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Ghee Rice</h4>
                                                        <p class="des">Rice</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/jeera-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Jeera Rice</h4>
                                                        <p class="des">Rice</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/peas-pulao-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Peas Pulav</h4>
                                                        <p class="des">Rice</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/curd-rice-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Curd Rice</h4>
                                                        <p class="des">Rice</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/dal-kichdi-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Dhal Kichadi</h4>
                                                        <p class="des">Rice</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/chicken-mutton/palak-kichdi-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Palak Kichadi</h4>
                                                        <p class="des">Rice</p>
