...
<head>
        ...
        <title>Coastal Style Restaurant Near International Airport Devanahalli Bangalore</title>
        <meta name="keyword" content="Coastal Style Restaurant Near International Airport Devanahalli Bangalore, coastal style restaurant near me, sea food, prawns, sea fish, coastal style restaurant in bangalore, takeaway sea fish free."/>
		<meta name="description" content="Best Coastal Style Restaurant Near International Airport Devanahalli in Bangalore prepares & serves best caostal style fish curry, sea food,sea fish & Prawns also takeaway free."> 
                        ...
                        <div class="col-sm-12">
                            <div class="dish owl-carousel">
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/01.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/02.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free..</span>
                                            <p>Rs.100</p>
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/03.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free..</span>
                                            <p>Rs.100</p>
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/04.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free..</span>
                                            <p>Rs.100</p>
                                ...
                                <div class="item">
                                    <!-- Box Start -->
                                    <div class="box">
                                        <a href="#"><img src="assets/images/dishes/05.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" /></a>
                                        <div class="caption">
                                            <h4>Dish Name Here</h4>
                                            <span>Takeaway within 4 kms are Free..</span>
                                            <p>Rs.100</p>
                    ...
                    <div class="container">
                        <div class="row ">
                            ...
                            <div class="col-sm-12 col-xs-12 commontop text-center">
                                <h4>Coastal Style Menu</h4>
                                <div class="divider style-1 center">
                                    <span class="hr-simple left"></span>
                                    <i class="icofont icofont-ui-press hr-icon"></i>
                                    <span class="hr-simple right"></span>
                                </div>
                                <p>Coastal cuisine is characterized by fresh, bright flavors that allow the simplicity of the ingredients to shine through. ... The focus is on high quality, fresh ingredients, including seafood, seasonal produce, grains, and nuts, which are locally and sustainably sourced whenever possible.</p>
                            </div>
                            <!-- Title Content End -->
                            <div class="col-sm-12 col-xs-12">                                                                                   
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/coastal-style/kundapura-chicken-curry-new-amaravathi-gardenia.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Kundapura Chicken Curry</h4>
                                                <p class="des">Dry/Semi Dry</p>
                                                <span>Takeaway within 4 kms are Free..</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/coastal-style/chicken-tawa-fry-new-amaravathi-gardenia.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Chicken Tawa Fry</h4>
                                                 <p class="des">Dry/Semi Dry</p>
                                                <span>Takeaway within 4 kms are Free..</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/coastal-style/chicken-gassi-new-amaravathi-gardenia.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Chicken Gassi</h4>
                                                <p class="des">Dry/Semi Dry</p>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/coastal-style/chicken-ghee-roast-new-amaravathi-gardenia.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/coastal-style/mangalorean-fish-curry-new-amaravathi-gardenia.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Mangalorian Fish Curry</h4>
                                               <p class="des">Dry/Semi Fish Curries</p>
                                                <span>Takeaway within 4 kms are Free..</span>
                                                <div class="price">Rs.Seasonal</div>
                                            </div>
                                        </div>
                                        <!-- Box End -->
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/coastal-style/fish-pulimunchi-new-amaravathi-gardenia.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Fish Pulimunchi</h4>
                                                <p class="des">Dry/Semi Fish Curries</p>
                                                <span>Takeaway within 4 kms are Free..</span>
                                                <div class="price">Rs.Seasonal</div>
                                            </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/coastal-style/prawns-65-new-amaravathi-gardenia.jpg" alt="coastal-style-restaurant-in-airport-bangalore" title="coastal-style-restaurant-in-airport-bangalore" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Prawns 65</h4>
                                                <p class="des">Dry/Semi Fish Curries</p>
