...
jQuery(document).ready(function($) {
    ...
    if (!($.cookie('tp_stylesheet'))) {
        ...
        if (link.length>0) {
            link.attr('href','http://www.newamaravathigardenia.in/assets/css/color/' + tp_stylesheet + '.css');
            $('.style-customizer .styleChange li[data-style="'+tp_stylesheet+'"]').addClass("selected");			 	
        };
    };	
    ...
    if ($("body").hasClass("header-0")){
        document.getElementById("logo_img").src="http://www.newamaravathigardenia.in/assets/images/logo/logo.png";
    } else {
        document.getElementById("logo_img").src="http://www.newamaravathigardenia.in/assets/images/logo/logo-white.png";
    }
    ...
    $('.style-customizer .styleChange li').on('click',function(){
        if (link.length>0) {
            ...
            $(".style-customizer .styleChange .selected").removeClass("selected");
            $this.addClass("selected");
            //link_no_cookie.attr('href', 'http://www.newamaravathigardenia.in/assets/css/color/' + tp_stylesheet_no_cookie + '.css');
        };
    });
