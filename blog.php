...
<head>
        ...
        <title>Order Food Online Andhra Style Restaurant in Bangalore</title>
        <meta name="keyword" content="Order Food Online Andhra Style Restaurant in Bangalore, bar & restaurant near devanahalli, best place for party non veg with drinks near devanahalli airport bangalore"/>
        <meta name="description" content="Order Food Online Andhra Style Restaurant in Bangalore with bar attached near airport devanahalli in bangalore serves non veg dishes with hot drinks & bevarages best place for party and celebration outside of bangalore"> 
                ...
                <div class="container">
                    <div class="matter">
                        ...
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><a href="#">Our Blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-12 commontop text-center">
                                ...
                                <p>Dear Customers please check for our delicious dishes & leave your valuable comments..</p>
                            </div>
                            <!-- Title Content End -->
                            <div class="col-sm-6 col-md-4">
                                <!-- Single Blog Start -->
                                <div class="box">
                                    <img src="assets/images/blog/b4.jpg" class="img-fluid" alt="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" title="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" />
                                    <div class="caption">
                                        ...
                                        <a class="btn btn-theme-alt btn-md" href="#">Read More <i class="icofont icofont-curved-double-right"></i></a>
                                    </div>
                                </div>	
                                <!-- Single Blog End -->
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <!-- Single Blog Start -->
                                <div class="box">
                                    <img src="assets/images/blog/b3.jpg" class="img-fluid" alt="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" title="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" />
                                    <div class="caption">
                                        <h4>Blog Title Here</h4>
                                        <p class="text">May 15, 2017 / By admin / 3 Comments</p>
                                        <p class="des">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam efficitur placerat nulla, in suscipit erat sodales id. Nullam ultricies eu turpis at accumsan...</p>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <!-- Single Blog Start -->
                                <div class="box">
                                    <img src="assets/images/blog/b8.jpg" class="img-fluid" alt="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" title="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" />
                                    <div class="caption">
                                        <h4>Blog Title Here</h4>
                                        <p class="text">May 15, 2017 / By admin / 3 Comments</p>
                                        <p class="des">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam efficitur placerat nulla, in suscipit erat sodales id. Nullam ultricies eu turpis at accumsan...</p>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <!-- Single Blog Start -->
                                <div class="box">
                                    <img src="assets/images/blog/b1.jpg" class="img-fluid" alt="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" title="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" />
                                    <div class="caption">
                                        <h4>Blog Title Here</h4>
                                        <p class="text">May 15, 2017 / By admin / 3 Comments</p>
                                        <p class="des">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam efficitur placerat nulla, in suscipit erat sodales id. Nullam ultricies eu turpis at accumsan...</p>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <!-- Single Blog Start -->
                                <div class="box">
                                    <img src="assets/images/blog/b5.jpg" class="img-fluid" alt="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" title="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" />
                                    <div class="caption">
                                        <h4>Blog Title Here</h4>
                                        <p class="text">May 15, 2017 / By admin / 3 Comments</p>
                                        <p class="des">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam efficitur placerat nulla, in suscipit erat sodales id. Nullam ultricies eu turpis at accumsan...</p>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <!-- Single Blog Start -->
                                <div class="box">
                                    <img src="assets/images/blog/b2.jpg" class="img-fluid" alt="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" title="Order-Food-Online-Andhra-Style-Restaurant-in-Bangalore" />
                                    <div class="caption">
                                        <h4>Blog Title Here</h4>
                                        <p class="text">May 15, 2017 / By admin / 3 Comments</p>
                                        <p class="des">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam efficitur placerat nulla, in suscipit erat sodales id. Nullam ultricies eu turpis at accumsan...</p>
...
<!-- Mirrored from www.spheretheme.com/steam/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Sep 2018 19:42:19 GMT -->
</html>
