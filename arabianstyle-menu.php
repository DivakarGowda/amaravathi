...
<head>
        ...
        <title>Arabian Style Menu</title>
                            ...
                            <div class="col-sm-12 col-xs-12">                                                                                   
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                                <img src="assets/images/our-menu/arabianfood/grilled-chicken-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <diV class="box">
                                            <div class="image">
                                               <img src="assets/images/our-menu/arabianfood/shawarma-roll-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-responsive" />
                                            </div>
                                            <div class="caption">
                                                <h4>Shawarma Roll</h4>
                                                <p class="des">Arabian Food</p>
