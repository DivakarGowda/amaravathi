                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <ul class="nav nav-tabs list-inline">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#soups" data-toggle="tab" aria-expanded="false">Soups</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#salads" data-toggle="tab" aria-expanded="false">Salads & Papad</a>
                                    </li>
                                ...
                                <div  class="tab-content">
                                    ...
                                    <!--  Menu Tab Start  -->
                                    <div class="tab-pane show active" id="soups">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/soups-salads/sweet-corn-veg-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Sweetcorn Soup</h4>
                                                        <p class="des">Vegitarian</p>
                                                        <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/Vegetable_Manchow_Soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Manchow Soup</h4>
                                                        <p class="des">Vegitarian</p>
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/Hot-N-Sour-Soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Hot & Sour Soup</h4>
                                                        <p class="des">Vegitarian</p>
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/VEG-CLEAR-SOUP-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/cream-of-tomato-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/cream-of-mushroom-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Cream Of Mushroom</h4>
                                                        <p class="des">Vegitarian</p>
                                                        <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                                        <div class="price">Rs.75.00</div>
                                                    </div>
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/hot-and-sour-chicken-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Hot & Sour Soup</h4>
                                                        <p class="des">Non-Vegitarian</p>
                                                        <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                                        <div class="price">Rs.85.00</div>
                                                    </div>
                                                </div>
                                                <!-- Box End -->
                                            </div>
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/chicken-manchow-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Manchow Soup</h4>
                                                        <p class="des">Non-Vegitarian</p>
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/Tom-Yum-Soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/chicken-lung-fung-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Chicken Lung-Fung Soup</h4>
                                                        <p class="des">Non-Vegitarian</p>
                                                        <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                                        <div class="price">Rs.85.00</div>
                                                    </div>
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/chicken-sweetcorn-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                       <img src="assets/images/our-menu/soups-salads/chicken-clear-soup-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                    ...
                                    <div class="tab-pane" id="salads">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/soups-salads/mix_veg_raita-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Mix Raitha</h4>
                                                        <p class="des">Salads & Papad</p>
                                                        <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/soups-salads/cucumbar-salad-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/soups-salads/green-salad-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Green Salad</h4>
                                                        <p class="des">Salads & Papad</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/soups-salads/onion-salad-new-amaravthi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Onion Salad</h4>
                                                        <p class="des">Salads & Papad</p>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <diV class="box">
                                                    <div class="image">
                                                        <img src="assets/images/our-menu/soups-salads/roasted_papad-new-amaravathi-gardenia.jpg" alt="image" title="image" class="img-fluid" />
                                                    </div>
                                                    <div class="caption">
                                                        <h4>Roasted Salad / Papad</h4>
                                                        <p class="des">Salads & Papad</p>
                                                        <span>Lorem ipsum is simply dummy text of the printing and type setting industry.</span>
                                                        <div class="price">Rs.30.40.00</div>
                                                    </div>
                                                </div>
                                                <!-- Box End -->
                                            </div>
